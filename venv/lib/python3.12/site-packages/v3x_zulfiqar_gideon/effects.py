...
class SceneHighlighter:
    ...
    def __init__(self, rect, overlay_alpha=180, custom_sections=None):
        ...
        Args:
            ...
            custom_sections (list[pg.Rect], optional): Explicit list of rects to use as spotlight sections.
                                                       If None, defaults to a 2-row (3 top, 4 bottom) grid.
        """
        ...
        if custom_sections:
            self.sections = [pg.Rect(r) for r in custom_sections]
        else:
            # Calculate default sections: 2 rows (top half has 3 panels, bottom half has 4 panels)
