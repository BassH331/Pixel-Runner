...
class AudioManager:
    ...
    def fadeout_sound(self, channel_id: int, duration_ms: int = 500) -> None:
        """Fade out a sound on the specified channel over the given duration (ms)."""
        if 0 <= channel_id < len(self.channels):
            self.channels[channel_id].fadeout(duration_ms)
    ...
    def set_master_volume(self, volume: float) -> None:
        """Set the master volume (0.0 to 1.0) and apply to all active channels immediately."""
